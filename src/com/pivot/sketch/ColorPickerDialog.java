/*
 * Edited and made better! by Karthik badam  :)
 */
...
public class ColorPickerDialog extends Dialog {
    ...
    private static class ColorPickerView extends View {
        ...
        protected void onDraw(Canvas canvas) {	
            ...
            canvas.drawCircle(0, -r/2, CENTER_RADIUS, white);
        ...
        public boolean onTouchEvent(MotionEvent event) {
            ...
            boolean inBlack = java.lang.Math.sqrt(x*x + (y-r/2)*(y-r/2)) <= CENTER_RADIUS;
            boolean inWhite = java.lang.Math.sqrt(x*x + (y+r/2)*(y+r/2)) <= CENTER_RADIUS;
